...
class Profile extends Component{
    state = {
        profilePict:  "https://avatars0.githubusercontent.com/u/22018903?s=460&v=4",
    };
    render(){
        return(
            <div>
                ...
                <div className="mx-auto container max-w-2xl md:w-0/12  shadow-md">
                    ...
                    <div className="max-w-sm mx-auto md:w-full md:mx-0">
                        ...
                        <img className="w-10 h-10 object-cover rounded-full" alt="User avatar" src={this.state.profilePict} />
                        <h1 className="text-gray-600">Gandhist</h1>
                        </div>
                    </div>
                    </div>
                    ...
                    <div className="md:inline-flex space-y-4 md:space-y-0 w-full p-4 text-gray-500 items-center">
                        ...
                        <div className="w-full inline-flex border">
                            ...
                            <input type="email" className="w-11/12 focus:outline-none focus:text-gray-600 p-2" placeholder="email@example.com" />
                        </div>
                        </div>
                    </div>
                    <hr />
                    <div className="md:inline-flex  space-y-4 md:space-y-0  w-full p-4 text-gray-500 items-center">
                        ...
                        <div>
                            ...
                            <input type="text" className="w-11/12 focus:outline-none focus:text-gray-600 p-2" placeholder="Your Full Name" />
                            </div>
                        </div>
                        <div>
                            ...
                            <input type="text" className="w-11/12 focus:outline-none focus:text-gray-600 p-2" placeholder={12341234} />
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div className="md:inline-flex w-full space-y-4 md:space-y-0 p-8 text-gray-500 items-center">
                        ...
                        <div className="w-full inline-flex border-b">
                            ...
                            <input type="password" className="w-11/12 focus:outline-none focus:text-gray-600 p-2 ml-4" placeholder="New" />
                        </div>
                        </div>
